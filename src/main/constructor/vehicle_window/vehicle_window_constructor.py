...
class VehicleWindowConstructor():
    def __init__(self, root):
        ...
        self.create_window = VehicleCreateWindowConstructor(self.right_frame)
    ...
    def readWindowCall(self):
        self.right_frame.place_forget()
        self.right_frame = RightFrame(self.root)
        self.read_window = VehicleReadWindowConstructor(self.right_frame)

    def updateWindowCall(self):
        self.right_frame.place_forget()
        self.right_frame = RightFrame(self.root)
        self.update_window = VehicleUpdateWindowConstructor(self.right_frame)

    def deleteWindowCall(self):
        self.right_frame.place_forget()
        self.right_frame = RightFrame(self.root)
        self.update_window = VehicleDeleteWindowConstructor(self.right_frame)
