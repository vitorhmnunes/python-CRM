...
class ClientWindowConstructor():
    def __init__(self, root):
        ...
        self.create_window = ClientCreateWindowConstructor(self.right_frame)
    ...
    def readWindowCall(self):
        self.right_frame.place_forget()
        self.right_frame = RightFrame(self.root)
        self.read_window = ClientReadWindowConstructor(self.right_frame)

    def updateWindowCall(self):
        self.right_frame.place_forget()
        self.right_frame = RightFrame(self.root)
        self.update_window = ClientUpdateWindowConstructor(self.right_frame)

    def deleteWindowCall(self):
        self.right_frame.place_forget()
        self.right_frame = RightFrame(self.root)
        self.update_window = ClientDeleteWindowConstructor(self.right_frame)
