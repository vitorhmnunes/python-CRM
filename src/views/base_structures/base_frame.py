...
class BaseFrame(CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.place(relx=0, rely=0.06, relwidth= 1, relheight=0.94)
        self.frames()
...
#frame for upper menu buttons
class UpperFrame(CTkFrame):
    def __init__(self, master, **kwargs):
        super().__init__(master, **kwargs)
        self.configure(corner_radius=0, fg_color='#1C1C1C', border_color='#000000', border_width=1)
        self.place(relx=0, rely=0, relwidth= 1, relheight=0.06 )
